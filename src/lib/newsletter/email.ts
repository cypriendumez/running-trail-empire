...
const T: Record<Lang, Chrome> = {
  fr: {
    ...
    chapo: "Ce qu'il fallait retenir cette semaine.",
  ...
  es: {
    ...
    chapo: "Lo que ha contado esta semana.",
  ...
  pt: {
    ...
    chapo: "O que contou esta semana.",
