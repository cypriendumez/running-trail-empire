...
export const HELP_PAGES: HelpPage[] = [
  ...
  { path: "/chaussures", how: "Adresse publique /chaussures, accessible sans compte. Aussi en pied de page, « Comparateur ».", keys: ["chaussure", "chaussures", "comparateur", "comparer", "modele", "modeles", "drop", "poids", "semelle", "paire", "sans compte", "public"], navKey: "nav.shop", name: "Comparateur de chaussures (public)", what: "Catalogue public de 309 modèles de chaussures de route, trail et piste : poids, drop, hauteur de semelle, durée de vie annoncée, avec la date du relevé et les sources. Accessible SANS COMPTE et référencé par les moteurs. Pacevo ne vend rien et n'affiche aucun prix marchand. Ce qui demande un compte, c'est le verdict personnel : savoir si un modèle convient à TON kilométrage, ton terrain et les paires que tu uses déjà." },
  { path: "/chaussures/[slug]", how: "Depuis /chaussures, cliquer un modèle. Chaque modèle a son adresse permanente.", keys: ["fiche chaussure", "modele", "drop", "poids", "stack", "plaque carbone", "duree de vie", "partager un modele"], navKey: "nav.shop", name: "Fiche publique d'un modèle", what: "Fiche publique d'une chaussure : poids, drop, hauteur de semelle au talon, plaque carbone, durée de vie annoncée, prix public conseillé du fabricant, type de foulée, millésime — chaque valeur avec sa date de relevé et ses sources. Une caractéristique inconnue est affichée « non communiqué », jamais devinée. Des modèles proches sont proposés en bas de page." },
