...
export type LandingDict = {
  ...
  sync: { title: string; read: string; readValue: string; push: string; pushApp: string; note: string };
...
const fr: LandingDict = {
  ...
  sync: { title: "Synchronisation avec", read: "Lecture de tes données :", readValue: "les {n} plateformes.", push: "Envoi de la séance sur ta montre :", pushApp: "Envoi vers une application d'entraînement :", note: "Tout passe par intervals.icu, qui gère les connexions officielles de chaque constructeur. Pacevo n'accède jamais directement à tes comptes. * Apple Watch n'a pas de connexion officielle : ses données arrivent via une application passerelle (HealthFit, Intervals Companion) qui verse Santé dans intervals.icu." },
  ...
  pricing: {
    ...
    plans: [
      ...
      { cle: "premium", name: "Premium", pitch: "Le même coach, plus 30 questions à l'IA par jour.", badge: "Le plus demandé", cta: "Essayer 7 jours",
        features: ["Tout le Starter", "30 échanges avec l'IA par jour", "Plans IA à la demande", "Smart Journal vocal", "Analyses longues et détaillées"] },
    ],
...
const en: LandingDict = {
  ...
  sync: { title: "Syncs with", read: "Reading your data:", readValue: "all {n} platforms.", push: "Sending the session to your watch:", pushApp: "Sending to a training app:", note: "Everything goes through intervals.icu, which handles each manufacturer's official connection. Pacevo never accesses your accounts directly. * Apple Watch has no official connection: its data arrives through a bridge app (HealthFit, Intervals Companion) that feeds Health into intervals.icu." },
  ...
  pricing: {
    ...
    plans: [
      ...
      { cle: "premium", name: "Premium", pitch: "The same coach, plus 30 AI questions a day.", badge: "Most popular", cta: "Try 7 days",
        features: ["Everything in Starter", "30 AI exchanges per day", "On-demand AI plans", "Voice Smart Journal", "Long, detailed analyses"] },
    ],
...
const de: LandingDict = {
  ...
  sync: { title: "Synchronisiert mit", read: "Deine Daten lesen:", readValue: "alle {n} Plattformen.", push: "Einheit auf deine Uhr senden:", pushApp: "An eine Trainings-App senden:", note: "Alles läuft über intervals.icu, das die offiziellen Verbindungen jedes Herstellers verwaltet. Pacevo greift nie direkt auf deine Konten zu. * Die Apple Watch hat keine offizielle Verbindung: Ihre Daten kommen über eine Brücken-App (HealthFit, Intervals Companion), die Health an intervals.icu weitergibt." },
  ...
  pricing: {
    ...
    plans: [
      ...
      { cle: "premium", name: "Premium", pitch: "Derselbe Coach, plus 30 KI-Fragen pro Tag.", badge: "Am beliebtesten", cta: "7 Tage testen",
        features: ["Alles aus Starter", "30 KI-Dialoge pro Tag", "KI-Pläne auf Abruf", "Smart Journal per Stimme", "Lange, ausführliche Analysen"] },
    ],
...
const es: LandingDict = {
  ...
  sync: { title: "Sincroniza con", read: "Lectura de tus datos:", readValue: "las {n} plataformas.", push: "Envío de la sesión a tu reloj:", pushApp: "Envío a una app de entrenamiento:", note: "Todo pasa por intervals.icu, que gestiona las conexiones oficiales de cada fabricante. Pacevo nunca accede directamente a tus cuentas. * El Apple Watch no tiene conexión oficial: sus datos llegan mediante una app puente (HealthFit, Intervals Companion) que vuelca Salud en intervals.icu." },
  ...
  pricing: {
    ...
    plans: [
      ...
      { cle: "premium", name: "Premium", pitch: "El mismo entrenador, más 30 preguntas a la IA al día.", badge: "El más elegido", cta: "Probar 7 días",
        features: ["Todo lo de Starter", "30 intercambios con la IA al día", "Planes IA a demanda", "Smart Journal por voz", "Análisis largos y detallados"] },
    ],
...
const pt: LandingDict = {
  ...
  sync: { title: "Sincroniza com", read: "Leitura dos teus dados:", readValue: "as {n} plataformas.", push: "Envio do treino para o teu relógio:", pushApp: "Envio para uma app de treino:", note: "Tudo passa pelo intervals.icu, que gere as ligações oficiais de cada fabricante. A Pacevo nunca acede diretamente às tuas contas. * O Apple Watch não tem ligação oficial: os dados chegam por uma app ponte (HealthFit, Intervals Companion) que envia a Saúde para o intervals.icu." },
  ...
  pricing: {
    ...
    plans: [
      ...
      { cle: "premium", name: "Premium", pitch: "O mesmo treinador, mais 30 perguntas à IA por dia.", badge: "O mais escolhido", cta: "Testar 7 dias",
        features: ["Tudo o do Starter", "30 trocas com a IA por dia", "Planos IA a pedido", "Smart Journal por voz", "Análises longas e detalhadas"] },
    ],
