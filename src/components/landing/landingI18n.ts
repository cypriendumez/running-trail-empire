...
const fr: LandingDict = {
  ...
  pricing: {
    eyebrow: "Tarifs", title: "Le coach est gratuit. L'IA se paie.",
    subtitle: "Le plan qui se replanifie tout seul ne nous coûte rien à faire tourner : il est gratuit, pour toujours. Ce sont les échanges avec l'IA qui ont un coût, et eux seuls se facturent.",
    ...
    plans: [
      { cle: "gratuit", name: "Gratuit", pitch: "Le coach entier, pour toujours.", cta: "Créer mon compte",
        features: ["Plan de 7 jours replanifié en continu", "VFC, sommeil, charge, affûtage Banister", "Sync Garmin, Coros, Strava", "Séances poussées sur la montre", "14 000 courses à venir", "Série, ligues et trophées", "Trail Builder et export GPX"] },
      { cle: "starter", name: "Starter", pitch: "Le coach, plus 10 questions à l'IA par jour.", cta: "Essayer 7 jours",
        features: ["Tout le gratuit", "10 échanges avec l'IA par jour", "Analyse IA de tes séances", "Kiné IA, avec photo", "Smart Journal vocal"] },
      { cle: "premium", name: "Premium", pitch: "Le coach, plus 30 questions à l'IA par jour.", badge: "Le plus demandé", cta: "Essayer 7 jours",
        features: ["Tout le Starter", "30 échanges avec l'IA par jour", "Plans IA à la demande", "Analyses longues et détaillées"] },
    ],
    apres: "À la fin de l'essai, rien ne se ferme : ton compte revient au palier gratuit. Le plan continue d'être recalculé chaque jour, tes séances continuent de partir sur ta montre. Seuls les échanges avec l'IA s'arrêtent.",
  },
...
const en: LandingDict = {
  ...
  pricing: {
    eyebrow: "Pricing", title: "The coach is free. The AI is what you pay for.",
    subtitle: "The plan that replans itself costs us nothing to run: it is free, forever. Only the AI exchanges have a cost, and only those are billed.",
    ...
    plans: [
      { cle: "gratuit", name: "Free", pitch: "The whole coach, forever.", cta: "Create my account",
        features: ["7-day plan, continuously replanned", "HRV, sleep, load, Banister tapering", "Garmin, Coros, Strava sync", "Sessions pushed to your watch", "14,000 upcoming races", "Streak, leagues and trophies", "Trail Builder and GPX export"] },
      { cle: "starter", name: "Starter", pitch: "The coach, plus 10 AI questions a day.", cta: "Try 7 days",
        features: ["Everything in Free", "10 AI exchanges per day", "AI analysis of your sessions", "AI physio, with photo", "Voice Smart Journal"] },
      { cle: "premium", name: "Premium", pitch: "The coach, plus 30 AI questions a day.", badge: "Most popular", cta: "Try 7 days",
        features: ["Everything in Starter", "30 AI exchanges per day", "On-demand AI plans", "Long, detailed analyses"] },
    ],
    apres: "When the trial ends nothing closes: your account returns to the free tier. The plan keeps being recalculated every day, your sessions keep reaching your watch. Only the AI exchanges stop.",
  },
...
const de: LandingDict = {
  ...
  pricing: {
    eyebrow: "Preise", title: "Der Coach ist gratis. Bezahlt wird die KI.",
    subtitle: "Der Plan, der sich selbst neu plant, kostet uns nichts im Betrieb: er ist für immer gratis. Nur die KI-Dialoge kosten etwas, und nur sie werden berechnet.",
    ...
    plans: [
      { cle: "gratuit", name: "Gratis", pitch: "Der ganze Coach, für immer.", cta: "Konto erstellen",
        features: ["7-Tage-Plan, laufend neu geplant", "HRV, Schlaf, Belastung, Banister-Tapering", "Sync mit Garmin, Coros, Strava", "Einheiten direkt auf die Uhr", "14 000 kommende Rennen", "Serie, Ligen und Trophäen", "Trail Builder und GPX-Export"] },
      { cle: "starter", name: "Starter", pitch: "Der Coach, plus 10 KI-Fragen pro Tag.", cta: "7 Tage testen",
        features: ["Alles aus Gratis", "10 KI-Dialoge pro Tag", "KI-Analyse deiner Einheiten", "KI-Physio, mit Foto", "Smart Journal per Stimme"] },
      { cle: "premium", name: "Premium", pitch: "Der Coach, plus 30 KI-Fragen pro Tag.", badge: "Am beliebtesten", cta: "7 Tage testen",
        features: ["Alles aus Starter", "30 KI-Dialoge pro Tag", "KI-Pläne auf Abruf", "Lange, ausführliche Analysen"] },
    ],
    apres: "Am Ende des Tests schließt sich nichts: dein Konto fällt auf die Gratis-Stufe zurück. Der Plan wird weiter täglich neu berechnet, deine Einheiten landen weiter auf der Uhr. Nur die KI-Dialoge enden.",
  },
...
const es: LandingDict = {
  ...
  pricing: {
    eyebrow: "Precios", title: "El entrenador es gratis. Lo que se paga es la IA.",
    subtitle: "El plan que se replanifica solo no nos cuesta nada: es gratis, para siempre. Solo los intercambios con la IA tienen un coste, y solo ellos se facturan.",
    ...
    plans: [
      { cle: "gratuit", name: "Gratis", pitch: "El entrenador entero, para siempre.", cta: "Crear mi cuenta",
        features: ["Plan de 7 días replanificado en continuo", "VFC, sueño, carga, afinamiento Banister", "Sync Garmin, Coros, Strava", "Sesiones enviadas al reloj", "14 000 carreras próximas", "Racha, ligas y trofeos", "Trail Builder y exportación GPX"] },
      { cle: "starter", name: "Starter", pitch: "El entrenador, más 10 preguntas a la IA al día.", cta: "Probar 7 días",
        features: ["Todo lo gratuito", "10 intercambios con la IA al día", "Análisis IA de tus sesiones", "Fisio IA, con foto", "Smart Journal por voz"] },
      { cle: "premium", name: "Premium", pitch: "El entrenador, más 30 preguntas a la IA al día.", badge: "El más elegido", cta: "Probar 7 días",
        features: ["Todo lo de Starter", "30 intercambios con la IA al día", "Planes IA a demanda", "Análisis largos y detallados"] },
    ],
    apres: "Al terminar la prueba no se cierra nada: tu cuenta vuelve al nivel gratuito. El plan se sigue recalculando cada día y tus sesiones siguen llegando al reloj. Solo se detienen los intercambios con la IA.",
  },
...
const pt: LandingDict = {
  ...
  pricing: {
    eyebrow: "Preços", title: "O treinador é grátis. Paga-se a IA.",
    subtitle: "O plano que se replanifica sozinho não nos custa nada a manter: é grátis, para sempre. Só as trocas com a IA têm custo, e só essas são faturadas.",
    ...
    plans: [
      { cle: "gratuit", name: "Grátis", pitch: "O treinador inteiro, para sempre.", cta: "Criar a minha conta",
        features: ["Plano de 7 dias replanificado em contínuo", "VFC, sono, carga, afinamento Banister", "Sync Garmin, Coros, Strava", "Sessões enviadas para o relógio", "14 000 provas futuras", "Série, ligas e troféus", "Trail Builder e exportação GPX"] },
      { cle: "starter", name: "Starter", pitch: "O treinador, mais 10 perguntas à IA por dia.", cta: "Testar 7 dias",
        features: ["Tudo o gratuito", "10 trocas com a IA por dia", "Análise IA das tuas sessões", "Fisio IA, com foto", "Smart Journal por voz"] },
      { cle: "premium", name: "Premium", pitch: "O treinador, mais 30 perguntas à IA por dia.", badge: "O mais escolhido", cta: "Testar 7 dias",
        features: ["Tudo o do Starter", "30 trocas com a IA por dia", "Planos IA a pedido", "Análises longas e detalhadas"] },
    ],
    apres: "No fim do teste nada se fecha: a tua conta volta ao nível gratuito. O plano continua a ser recalculado todos os dias e as tuas sessões continuam a chegar ao relógio. Só as trocas com a IA param.",
  },
