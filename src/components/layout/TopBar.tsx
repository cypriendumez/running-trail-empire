  ...
  return (
    <header className="h-16 border-b border-zinc-100 bg-white/80 backdrop-blur-sm flex items-center px-6 gap-4 sticky top-0 z-30">
      ...
      <div ref={searchRef} className="relative flex-1 max-w-md">
        <div className="flex items-center gap-2 px-3.5 py-2.5 bg-zinc-50 rounded-2xl border border-zinc-200 focus-within:ring-2 focus-within:ring-green-500/40 focus-within:border-green-400 transition-all">
          ...
          <div className="absolute left-0 right-0 top-full mt-2 max-h-[26rem] overflow-y-auto rounded-2xl border border-zinc-200 bg-white shadow-xl z-50">
            {raceHits.length === 0 && parcoursHits.length === 0 ? (
              ...
              <>
                ...
                <button onClick={() => goRace()} className="block w-full border-t border-zinc-100 px-4 py-2.5 text-center text-xs font-semibold text-green-600 transition-colors hover:bg-green-50">
            ...
            <>
              ...
              <div className="absolute right-0 mt-2 w-80 max-h-[26rem] overflow-y-auto rounded-2xl border border-zinc-200 bg-white shadow-xl z-50">
                <div className="flex items-center justify-between px-4 py-3 border-b border-zinc-100 sticky top-0 bg-white">
                  ...
                  {unread > 0 && (
                    <button onClick={markAllRead} className="text-xs text-green-600 hover:text-green-700 flex items-center gap-1">
                ...
                {loadingNotif ? (
                  ...
                  <ul className="divide-y divide-zinc-50">
                    {notifs.map((n) => (
                      <li key={n.id} className={`flex gap-3 px-4 py-3 ${n.read ? "" : "bg-green-50/40"}`}>
