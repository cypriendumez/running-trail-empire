...
// marque ». C'ÉTAIT FAUX, et deux fois : le compte réel est de 162 photos (154 Pexels
// + 8 Unsplash), et la liste « vérifiée » contenait les TROIS pires images du projet —
// la photo aux trois bandes Adidas (catégorie `running`), celle au swoosh Nike plus
// « Brooks » (`marathon`), et un visage net et identifiable (`trail`). Un commentaire
// qui proclame une vérification n'en est pas une.
//
// ÉTAT RÉEL au 20/08/2026 : les 8 identifiants Unsplash ont été regardés un par un, au
// format servi ; les 3 cités ci-dessus sont remplacés par des photos déjà auditées.
// Les 154 photos PEXELS n'ont PAS été auditées — ne pas réécrire ici qu'elles le sont.
...
const PHOTOS: Record<Cat, string[]> = {
  ...
  marathon: [PX(2402734), PX(2461977), PX(2461982), PX(2526884), PX(4606708), PX(29400388), PX(7523360), PX(18408950), PX(18275606), PX(33608349), PX(2526889), PX(10313865), PX(3518952), PX(2719567), PX(18521752), PX(18408979), PX(14585153), PX(17982926), PX(10313671), PX(30770061), PX(29694800), PX(10313668), PX(10313672), PX(10313674), PX(10168171), PX(10499987), PX(4040245), PX(20037838), PX(10226364), PX(10313669), PX(2567025), PX(2567040), PX(18408962), PX(18409405), PX(7523389), PX(18408960), PX(5051379), UN("1590333748338-d629e4564ad9")],
