...
export const WEIGHT_EXPLAIN: Record<string, Record<string, string>> = {
  fr: {
    ...
    "c.suivi_seul": "Suivi seul : aucun déficit calorique. La cible affichée est ta dépense — ce qu'il faut manger pour maintenir ton poids actuel.",
  ...
  en: {
    ...
    "c.suivi_seul": "Tracking only: no calorie deficit. The target shown is your expenditure — what to eat to hold your current weight.",
  ...
  de: {
    ...
    "c.suivi_seul": "Nur Verfolgung: kein Kaloriendefizit. Das gezeigte Ziel ist dein Verbrauch — was du isst, um dein Gewicht zu halten.",
  ...
  es: {
    ...
    "c.suivi_seul": "Solo seguimiento: sin déficit calórico. El objetivo mostrado es tu gasto — lo que hay que comer para mantener tu peso actual.",
  ...
  pt: {
    ...
    "c.suivi_seul": "Apenas acompanhamento: sem défice calórico. O objetivo mostrado é o teu gasto — o que comer para manteres o peso atual.",
