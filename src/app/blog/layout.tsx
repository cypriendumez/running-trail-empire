 ...
 */
export const metadata: Metadata = { title: "Conseils course à pied et trail", description: "Entraînement, allures, blessures, matériel : les articles de Pacevo pour progresser sans se blesser." };
