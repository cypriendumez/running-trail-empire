 ...
 *
 * ⚠️ « QUATRE JOURS » VIENT DE CYPRIEN, PAS DES DONNÉES. Ses activités s'étalent du 14
 * au 18/07/2025, soit cinq dates — mais il n'a pas tout enregistré, et c'est lui qui a
 * fait le tour. Le nombre de jours est donc de sa main, comme le 39:13 : un fait qu'il
 * rapporte, pas une mesure. Ne pas « corriger » en cinq d'après l'historique, ce serait
 * remplacer sa parole par une trace incomplète.
 *
...
export type HistoirePage = {
  ...
  fermetureAvant: string;
  fermetureApres: string;
  cta: string;
};


/**
 * LA SEULE DONNÉE TEMPORELLE DE LA PAGE — et elle est pilotée, pas écrite dans le texte.
 *
 * ⚠️ LA PAGE SE PÉRIMAIT TOUTE SEULE, ET PILE SUR SA DERNIÈRE PHRASE. Deux affirmations
 * étaient au futur : « Lille sera mon premier marathon » et « Le marathon de Lille
 * approche ». Le lendemain de la course, les deux devenaient fausses — juste au-dessus
 * du bouton d'inscription, c'est-à-dire la dernière chose que lit un visiteur. Rien dans
 * le code ne l'aurait signalé : c'est exactement la classe de défaut que ce projet
 * traque, une affirmation que plus personne ne revérifie.
 *
 * La date vient de DEUX sources concordantes, relevées le 17/09/2026 :
 *  · le catalogue de courses — « Marathon International de Lille », 42,2 km, 2026-10-25 ;
 *  · l'objectif déclaré dans l'application par Cyprien — même date.
 *
 * ⚠️ LE TEXTE D'APRÈS-COURSE N'ANNONCE AUCUN RÉSULTAT. Il ne peut pas : personne ne
 * connaît le chrono à l'avance, et l'inventer serait précisément ce que ce projet
 * s'interdit. Il dit ce qui reste vrai quoi qu'il arrive — que l'application a préparé
 * cette course. Un résultat, s'il mérite d'être raconté, s'ajoute à la main, après.
 */
export const DATE_PREMIER_MARATHON = "2026-10-25";
...
export const HISTOIRE: Record<Lang, HistoirePage> = {
    ...
    etapes: [
      {
        ...
        titre: "Le déclic",
        texte: "Ma première vraie course : un 10 kilomètres, inscrit sans y avoir réfléchi. 39 minutes 13. Je ne courais pas vraiment avant ça — quelques sorties pour accompagner ma mère, sans y prendre goût. Ce chrono a tout déclenché.",
      },
      {
        annee: "2024",
      ...
      {
        annee: "Juillet 2025",
        titre: "Le Tour du Mont-Blanc, décidé du jour au lendemain",
      ...
      },
      {
        ...
        texte: "Mon premier marathon, ce serait Lille. Et là, s'informer ne suffisait plus. Tout ce que j'avais appris était général : des principes, des pourcentages, des semaines types. Ce dont j'avais besoin, c'était d'une séance précise pour demain, tenant compte de ma nuit, de ma fatigue et de ce que j'avais couru la veille. Ma montre mesurait déjà tout — variabilité cardiaque, sommeil, charge, allures — et rien ne transformait ces mesures en décision. Alors j'ai construit Pacevo, en apprenant à coder avec l'intelligence artificielle comme copilote.",
      },
    ],
    fermetureTitre: "Aujourd'hui",
    fermetureAvant: "Le marathon de Lille approche, et l'application s'entraîne avec moi. C'est aussi la règle que je m'impose : aucune fonctionnalité n'est ajoutée si je ne m'en sers pas moi-même pour préparer une course.",
    fermetureApres: "Lille était mon premier marathon, et l'application s'est entraînée avec moi jusqu'à la ligne de départ. C'est aussi la règle que je m'impose : aucune fonctionnalité n'est ajoutée si je ne m'en sers pas moi-même pour préparer une course.",
    cta: "Essayer Pacevo",
  },
  en: {
    navLabel: "Our story",
    ...
    etapes: [
      { annee: "September 2023", titre: "The spark", texte: "My first real race: a 10K, entered without thinking twice. 39 minutes 13. I was not really a runner before that — a few outings to keep my mother company, without enjoying it much. That time changed everything." },
      ...
      { annee: "July 2025", titre: "The Tour du Mont-Blanc, decided overnight", texte: "With Louis we walked the whole Tour du Mont-Blanc, decided almost overnight. The complete loop around the massif, from Saint-Gervais to Courmayeur and on to Orsières: three countries in four days on foot. No race, no stopwatch — but that is where you understand what endurance means, and why recovery matters as much as training." },
      { annee: "2023 → 2026", titre: "I wanted to improve, and nobody was there to tell me how", texte: "My business studies never left me time to join a club. No club meant no coach — and yet the urge to improve on every run, to push further at every start line. So I taught myself: books, hours of videos, and above all long conversations with the runners around me. I ended up understanding training, recovery and nutrition." },
      { annee: "October 2026", titre: "I needed precise sessions, not theory", texte: "My first marathon would be Lille. And there, reading up was no longer enough. Everything I had learned was general: principles, percentages, template weeks. What I needed was a precise session for tomorrow, accounting for my night, my fatigue and what I had run the day before. My watch already measured everything — heart-rate variability, sleep, load, paces — and nothing turned those measurements into a decision. So I built Pacevo, learning to code with artificial intelligence as a copilot." },
    ],
    fermetureTitre: "Today",
    fermetureAvant: "The Lille marathon is coming, and the app trains alongside me. That is the rule I hold myself to: no feature ships unless I use it myself to prepare for a race.",
    fermetureApres: "Lille was my first marathon, and the app trained alongside me all the way to the start line. That is the rule I hold myself to: no feature ships unless I use it myself to prepare for a race.",
    cta: "Try Pacevo",
  },
  de: {
    ...
    etapes: [
      { annee: "September 2023", titre: "Der Auslöser", texte: "Mein erstes richtiges Rennen: ein 10-Kilometer-Lauf, ohne lange zu überlegen gemeldet. 39 Minuten 13. Davor war ich kein Läufer – ein paar Runden zur Begleitung meiner Mutter, ohne echte Freude daran. Diese Zeit hat alles ausgelöst." },
      ...
      { annee: "Juli 2025", titre: "Die Tour du Mont-Blanc, über Nacht beschlossen", texte: "Mit Louis haben wir die ganze Tour du Mont-Blanc erwandert, fast über Nacht beschlossen. Die komplette Runde um das Massiv, von Saint-Gervais über Courmayeur bis Orsières: drei Länder in vier Tagen zu Fuß. Kein Rennen, keine Stoppuhr – aber dort versteht man, was Ausdauer bedeutet und warum Erholung genauso zählt wie Training." },
      { annee: "2023 → 2026", titre: "Ich wollte besser werden, und niemand sagte mir wie", texte: "Mein Wirtschaftsstudium ließ mir nie Zeit für einen Verein. Kein Verein hieß kein Trainer – und trotzdem der Wunsch, bei jedem Lauf besser zu werden und bei jedem Start über mich hinauszugehen. Also habe ich es mir selbst beigebracht: Bücher, stundenlange Videos und vor allem lange Gespräche mit den Läufern um mich herum. Nach und nach verstand ich Training, Erholung und Ernährung." },
      { annee: "Oktober 2026", titre: "Ich brauchte genaue Einheiten, keine Theorie", texte: "Mein erster Marathon sollte Lille werden. Und da reichte Nachlesen nicht mehr. Alles Gelernte war allgemein: Prinzipien, Prozentwerte, Musterwochen. Gebraucht hätte ich eine genaue Einheit für morgen, die meine Nacht, meine Müdigkeit und den Lauf von gestern berücksichtigt. Meine Uhr maß längst alles – Herzratenvariabilität, Schlaf, Belastung, Tempo – und nichts machte daraus eine Entscheidung. Also habe ich Pacevo gebaut und dabei das Programmieren mit künstlicher Intelligenz als Kopilot gelernt." },
    ],
    fermetureTitre: "Heute",
    fermetureAvant: "Der Marathon von Lille rückt näher, und die App trainiert mit. Das ist auch meine Regel: keine Funktion, die ich nicht selbst zur Wettkampfvorbereitung nutze.",
    fermetureApres: "Lille war mein erster Marathon, und die App hat bis zur Startlinie mittrainiert. Das ist auch meine Regel: keine Funktion, die ich nicht selbst zur Wettkampfvorbereitung nutze.",
    cta: "Pacevo testen",
  },
  es: {
    ...
    etapes: [
      { annee: "Septiembre de 2023", titre: "El detonante", texte: "Mi primera carrera de verdad: un 10 km, apuntado sin pensarlo. 39 minutos 13. Antes no era corredor — alguna salida para acompañar a mi madre, sin disfrutarlo demasiado. Ese tiempo lo cambió todo." },
  ...
  pt: {
    ...
    etapes: [
      { annee: "Setembro de 2023", titre: "O clique", texte: "A minha primeira corrida a sério: uns 10 km, inscrito sem pensar duas vezes. 39 minutos 13. Antes disso não era corredor — umas saídas para acompanhar a minha mãe, sem grande gosto. Aquele tempo mudou tudo." },
      ...
      { annee: "Julho de 2025", titre: "A Volta ao Monte Branco, decidida de um dia para o outro", texte: "Com o Louis fizemos a Volta ao Monte Branco inteira, a caminhar, decidida quase de um dia para o outro. A volta completa ao maciço, de Saint-Gervais a Courmayeur e depois Orsières: três países em quatro dias a pé. Nenhuma prova, nenhum crono — mas é ali que se percebe o que é a resistência, e porque a recuperação conta tanto como o treino." },
      { annee: "2023 → 2026", titre: "Queria progredir e ninguém estava lá para me dizer como", texte: "Os meus estudos de comércio nunca me deixaram tempo para entrar num clube. Sem clube não há treinador — e mesmo assim a vontade de melhorar em cada saída, de me superar em cada dorsal. Formei-me sozinho: livros, horas de vídeos e, sobretudo, longas conversas com os corredores à minha volta. Acabei por perceber o treino, a recuperação e a nutrição." },
      { annee: "Outubro de 2026", titre: "Precisava de treinos precisos, não de teoria", texte: "A minha primeira maratona seria Lille. E aí informar-me deixou de chegar. Tudo o que tinha aprendido era geral: princípios, percentagens, semanas-tipo. O que me faltava era um treino preciso para amanhã, a contar com a minha noite, o meu cansaço e o que tinha corrido na véspera. O meu relógio já media tudo — variabilidade cardíaca, sono, carga, ritmos — e nada transformava essas medidas numa decisão. Foi assim que construí a Pacevo, aprendendo a programar com a inteligência artificial como copiloto." },
    ],
    fermetureTitre: "Hoje",
    fermetureAvant: "A maratona de Lille aproxima-se e a aplicação treina comigo. É também a regra que me imponho: nenhuma funcionalidade entra se eu próprio não a usar para preparar uma prova.",
    fermetureApres: "Lille foi a minha primeira maratona e a aplicação treinou comigo até à linha de partida. É também a regra que me imponho: nenhuma funcionalidade entra se eu próprio não a usar para preparar uma prova.",
