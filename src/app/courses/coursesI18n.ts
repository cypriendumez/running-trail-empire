...
export const C: Record<LangCourses, Record<string, string>> = {
  fr: {
    ...
    "terrain.forest": "forêt", "terrain.asphalt": "route", "terrain.coastal": "littoral", "terrain.limestone": "calcaire", "terrain.garrigue": "garrigue", "terrain.gravel": "chemin gravillonné", "terrain.pasture": "pâturage", "terrain.vineyard": "vignes", "terrain.wetland": "zone humide", "terrain.alpine": "haute montagne", "terrain.sandy": "sable", "terrain.technical": "technique", "terrain.single_track": "sentier", "terrain.trail": "sentier", "terrain.mountain": "montagne",
 ...
 "introuvable": "Course introuvable",
  ...
  en: {
    ...
    "terrain.forest": "forest", "terrain.asphalt": "road", "terrain.coastal": "coastal", "terrain.limestone": "limestone", "terrain.garrigue": "scrubland", "terrain.gravel": "gravel track", "terrain.pasture": "pasture", "terrain.vineyard": "vineyards", "terrain.wetland": "wetland", "terrain.alpine": "high mountain", "terrain.sandy": "sand", "terrain.technical": "technical", "terrain.single_track": "single track", "terrain.trail": "trail", "terrain.mountain": "mountain",
 ...
 "introuvable": "Race not found",
  ...
  de: {
    ...
    "terrain.forest": "Wald", "terrain.asphalt": "Straße", "terrain.coastal": "Küste", "terrain.limestone": "Kalkstein", "terrain.garrigue": "Garrigue", "terrain.gravel": "Schotterweg", "terrain.pasture": "Weide", "terrain.vineyard": "Weinberge", "terrain.wetland": "Feuchtgebiet", "terrain.alpine": "Hochgebirge", "terrain.sandy": "Sand", "terrain.technical": "technisch", "terrain.single_track": "Singletrail", "terrain.trail": "Trail", "terrain.mountain": "Berg",
 ...
 "introuvable": "Lauf nicht gefunden",
  ...
  es: {
    ...
    "terrain.forest": "bosque", "terrain.asphalt": "asfalto", "terrain.coastal": "litoral", "terrain.limestone": "caliza", "terrain.garrigue": "matorral", "terrain.gravel": "pista de grava", "terrain.pasture": "pasto", "terrain.vineyard": "viñedos", "terrain.wetland": "humedal", "terrain.alpine": "alta montaña", "terrain.sandy": "arena", "terrain.technical": "técnico", "terrain.single_track": "sendero", "terrain.trail": "sendero", "terrain.mountain": "montaña",
 ...
 "introuvable": "Carrera no encontrada",
  ...
  pt: {
    ...
    "terrain.forest": "floresta", "terrain.asphalt": "estrada", "terrain.coastal": "litoral", "terrain.limestone": "calcário", "terrain.garrigue": "matagal", "terrain.gravel": "caminho de gravilha", "terrain.pasture": "pastagem", "terrain.vineyard": "vinhas", "terrain.wetland": "zona húmida", "terrain.alpine": "alta montanha", "terrain.sandy": "areia", "terrain.technical": "técnico", "terrain.single_track": "trilho", "terrain.trail": "trilho", "terrain.mountain": "montanha",
