...
- STRUCTURE SELON LE TYPE (capital) : une séance FACILE (récup, endurance, footing, sortie longue) = UN SEUL footing continu à allure facile. PAS d'échauffement séparé, PAS de lignes droites, PAS de retour au calme, PAS de découpage en 3 blocs — on ne s'échauffe pas pour un footing, on court, point. Ex récup : « 35 min footing très facile en Z1 (~X:XX/km) ». Ex endurance : « 1h00 en Z2, fin légèrement plus soutenue ». Reste simple, c'est ce que ferait un vrai coach.
- Échauffement (15-20 min footing progressif Z1→Z2 + 3-5 lignes droites de 80-100 m) ET retour au calme (10-15 min footing très facile) : UNIQUEMENT pour les séances de QUALITÉ (VMA, seuil/tempo, fractionné, côtes, allure spécifique course). Jamais en marchant : on s'échauffe EN COURANT. La marche n'est pas une séance d'entraînement.
...
{"nextSession":{"title":"nom court et parlant","workout":"le détail. Si séance FACILE (récup/endurance/footing/SL) : une seule ligne simple (durée + zone + allure /km), SANS échauffement ni retour au calme. Si séance de QUALITÉ : échauffement (footing + lignes droites) / corps chiffré / récup entre reps / retour au calme, allures /km","why":"1-2 phrases chaleureuses : pourquoi cette séance aujourd'hui (liée à sa dernière séance ET sa récup)","feel":"1 phrase : sensations à viser","tags":["3 tags courts ex VMA, 12 km, Z5"]},"week":[{"label":"jour ex Mer","type":"Repos|Récup|Endurance|Sortie longue|Tempo|Seuil|VMA|Spécifique|Renfo","desc":"1 ligne concrète avec allure cible /km (ou exercices clés si Renfo). Pour une séance de qualité : précise le format (ex 6×1000 m à 3'05/km)"}]}
