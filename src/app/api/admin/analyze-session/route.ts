...
{"nextSession":{"title":"nom court et parlant","workout":"le détail STRUCTURÉ en 3 temps, allures /km partout : ÉCHAUFFEMENT (≥15 min footing progressif Z1→Z2) puis CORPS (durée + zone + allure ; ou format chiffré + lignes droites + récup entre reps si QUALITÉ) puis RETOUR AU CALME (≥10 min footing très facile Z1)","why":"1-2 phrases chaleureuses : pourquoi cette séance aujourd'hui (liée à sa dernière séance ET sa récup)","feel":"1 phrase : sensations à viser","tags":["3 tags courts ex VMA, 12 km, Z5"]},"week":[{"label":"jour ex Mer","type":"Repos|Récup|Endurance|Sortie longue|Tempo|Seuil|VMA|Spécifique|Renfo","desc":"1 ligne concrète avec allure cible /km (ou exercices clés si Renfo). Pour une séance de qualité : précise le format (ex 6×1000 m à 3'05/km)"}]}
